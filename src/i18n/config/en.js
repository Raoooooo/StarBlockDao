export default {
    ...
    course: {
        ...
        guide1: "Participate in staking NFT to get WNFT certificate",
        guide2: "You can get STB and WETH rewards when you hold WNFT",
        guide3: "1 WNFT = 1 NFT",
        guide4: "Only by holding WNFT can the original NFT be retrieved by unstaking",

        item1Title: "What is Stake Farming?",
        ...
        item3Title: "What is the process of Stake Farming?",
        item3Des: "Teach you how to stake farming",
        item3Link: "https://docs.starblock.io/main/v/english/tutorials/nft-staking",
        item4Title: "Application for Stake Farming",
        item4Des: "Tell us which pool you want to add",
        item4Link: "https://forms.gle/83sgDR1NjMMfXBvKA",
    },

    FAQ: {
        title1: "What is NFT Farming?",
        descrip1: "StarBlock DAO's NFT staking rewards allow NFT holders to earn STB tokens and royalties WETH dividends by staking prescribed NFTs on the platform.\n\nAfter staking NFT, holders will get the same Wrapped NFT as the staked NFT, referred to as WNFT. WNFT can be traded on any NFT Marketplace. If the trading generates royalties, it will be rewarded to WNFT holders as dividends.",
        title2: "What is the rewarding rule?",
        descrip2Sub1: "StarBlock DAO officially launched a collection of NFTs available for staking. After the NFT in these collections is staked, the certificate NFT-WNFT will be obtained. Earn STB rewards based on how long you hold WNFT.\nThe pool reward has four halving periods: 30, 90, 240 and 360 days, which is an important part of the economic model designed for the stable and sustainable development of StarBlock DAO. The full rules of the reward are here:",
        ...
        title5: "What is STB?",
        descrip5: "StarBlock DAO has issued the governance token StarBlock Token (STB), holding STB will have governance rights, dividend rights, proposal rights and other rights. At the same time, STB as a trading tokrn, can also be used to trade NFT on starblock platform.",
        title6: "How to get STB reward?",
        descrip6: "After the NFT is staked, the STB reward will be calculated, and the staking reward will be settled every time a block passes. According to the different farming pools, the number of rewards for each pool is different.",
        title7: "Is my NFT safe?",
        descrip7: "The NFT staked by the user is absolutely safe. The NFT stake farming is a full Web3 application. All operations are completed on the Ethereum blockchain. After staking, the user's NFT will be transferred to the WNFT contract, and the user will obtain WNFT as a staking certificate. , only users who hold WNFT can unstake the original NFT, and no one else, including the administrator, will not be able to withdraw the user's NFT.",
        title8: "Where can I find stake or unstake records?",
        descrip8: "The stake and unstake operations are completed on the blockchain. By clicking the block browser button of the farming pool, you can query both stake and unstake information of the farming pool, and filter your address to query all your transcation records.",
        ...
        title10: "Why is authorization required?",
        descrip10: "When staking and unstaking, we need to obtain authorization from your wallet before the contract can process your NFT or WNFT.",
        title11: "How to make NFT Farming  to support more collections?",
        descrip11Sub1: "Please submit this application:",
        descrip11Sub2: "https://forms.gle/83sgDR1NjMMfXBvKA",
        descrip11Sub3: ",and add the collection to our NFT Farming List. Once the number of applications reaches 100, the collection will be automatically launched.",
        title12: "What is the contract address of NFT Staking?",
