export default {
    ...
    common: {
        ...
        defaultMessSub4: "Are you sure to get staking rewards",
        ...
        time_h: "h",
        timeBefore: "ago",
        transationDoing: "Waiting for transaction confirmation",
        noTransation: "No transactions in progress since reload page",

        optionName1: "Approve to Stake",
        optionName2: "Approve to Unstake",
        ...
        rewardAlertDesSub2: "STB rewards will be issued to your wallet, please confirm your transaction in the wallet",
        rewardAlertDes_successSub1: "Add STB Token to your wallet to view balance",
        rewardAlertDes_successSub2: "STB can be used to trade NFTs on StarBlock",
