export default {
    ...
    common: {
        ...
        rewardAlertDesSub1: "STB挖矿奖励跟随出块发放，请以实际领取数量为准",
        rewardAlertDesSub2: "奖励将发放到您钱包中，请在钱包中确认您的交易",
        rewardAlertDes_successSub1: "将STB Token添加到您的钱包中即可查看STB余额",
        rewardAlertDes_successSub2: "STB可用于在StarBlock交易NFT",
        tradingNFT: "交易NFT",
        tradingWNFT: "交易WNFT",
